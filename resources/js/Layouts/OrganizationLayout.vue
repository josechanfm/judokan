        ...
        >
          ...
          <nav class="text-sm" v-if="breadcrumb">
            <ol class="list-none flex">
              <li
                class="breadcrumb-item hidden md:inline"
              ...
              <li class="breadcrumb-item block md:hidden">
                ...
                <span v-else>
                  <inertia-link :href="route('manage')"> Home </inertia-link>
                </span>
              </li>
              <li>
...
export default {
  ...
  setup(props) {
    const menuKeys = reactive({
      menuOpenKey: [route().current().split(".").slice(1, 2).join(".")],
      menuSelectKey: [route().current().split(".").slice(1).join(".")],
    });
